(function (translator) {
	translator.translations["es"] = {
		...
		"paperlabelbitcoinaddress": "Dirección Alarmx:",
		...
		"brainalertpassphrasewarning": "Aviso: Es importante escoger una contraseña fuerte para evitar ataques de fuerza bruta a fin de adivinarla y robar tus Alarmx.",
		...
		"vanityalertinvalidinputcannotmultiple": "Entrada no válida. No se puede multiplicar dos claves públicas. Seleccione 'Añadir' para agregar dos claves públicas para obtener una dirección Alarmx.",
		...
		"tagline": "Generador de carteras Alarmx de código abierto en lado de cliente con Javascript",
		"generatelabelbitcoinaddress": "Generando dirección Alarmx...",
		...
		"singlelabelbitcoinaddress": "Dirección Alarmx",
		...
		"bulklabelq1": "¿Por qué debo usar \"Direcciones en masa\" para aceptar Alarmx en mi web?",
		"bulka1": "La forma tradicional de aceptar Alarmx en tu web requiere tener instalado el cliente oficial de Alarmx (\"alarmxd\"). Sin embargo muchos servicios de hosting no permiten instalar dicho cliente. Además, ejecutar el cliente en tu servidor supone que las claves privadas están también en el servidor y podrían ser comprometidas en caso de intrusión. Al usar este mecanismo, puedes subir al servidor sólo las dirección de Alarmx y no las claves privadas. De esta forma no te tienes que preocupar de que alguien robe la cartera si se cuelan en el servidor.",
		"bulklabelq2": "¿Cómo uso \"Direcciones en masa\" para aceptar Alarmx en mi web?",
		...
		"bulklabela2li3": "Ofrece una alternativa en el carro de la compra de tu web para que los clientes paguen con Alarmx. Cuando el cliente elija pagar con Alarmx, les muestras una de las direcciones de la base de datos como su \"dirección de pago\" y guardas esto junto con el pedido.",
		"bulklabela2li4": "Ahora te hace falta recibir una notificación del pago. Busca en google \"notificación de pagos Alarmx\" (o \"Alarmx payment notification\" en inglés) y suscríbete a alguno de los servicios que aparezcan. Hay varios de ellos, que te pueden notificar vía Web services, API, SMS, email, etc. Una vez te llegue la notificación, lo cual puede ser automatizado, entonces ya puedes procesar el pedido. Para comprobar a mano si has recibido un pago, puedes usar Block Explorer: reemplaza DIRECCION a continuación por la dirección que estés comprobando. La transacción puede tardar entre 10 minutos y una hora en ser confirmada. <br />http://explorer.alarmx.io/address/DIRECCION<br /><br />Puedes ver las transacciones sin confirmar en: https://bchain.info/Alarmx/ http://insight.alarmx.siampm.com/ <br />Las transacciones sin confirmar suelen aparecer ahí en unos 30 segundos.",
		"bulklabela2li5": "Las Alarmx que recibas se almacenarán de forma segura en la cadena de bloques. Usa la cartera original que generaste en el paso 1 para usarlas.",
		...
		"brainlabelbitcoinaddress": "Dirección Alarmx:",
		...
		"vanitylabelbitcoinaddress": "Dirección Alarmx personalizada:",
		...
		"detaillabelnote2": "Alarmx v0.6+ almacena las claves públicas comprimidas. El cliente también soporta importar/exportar claves privadas usando importprivkey/dumpprivkey. El formato de las claves privadas exportadas depende de si la dirección se generó en una cartera antigua o nueva.",
		"detaillabelbitcoinaddress": "Dirección Alarmx:",
		"detaillabelbitcoinaddresscomp": "Dirección Alarmx (comprimida):",
