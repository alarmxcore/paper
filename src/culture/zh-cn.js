(function (translator) {
	translator.translations["zh-cn"] = {
		...
		"singletip4": "<b>查询余额：</b> 访问explorer.alarmx.io可以查看到任何地址中的比特币余额。",
		...
		"bulklabela2li4": "接下来你需要一个收款通知，联系相关服务的供应商（谷歌搜索“Alarmx payment notification”），它们可以监视指定地址的资金变动，并通过WebAPI、短信、电邮或者其他方式来提醒你，你也可以通过编程使一切自动化。在http://explorer.alarmx.io/address/地址 或者 https://bchain.info/Alarmx/ http://insight.alarmx.siampm.com/地址 查看交易确认数。通常情况下，你能够在30秒之内看见交易，而根据你对安全的要求不同，你可能需要10分钟到1小时的时间等待交易确认。",
		...
		"detaillabelnote2": "Alarmx v0.6+ 存储压缩格式的公钥。现在客户端支持导入/导出私钥，命令是importprivkey/dumpprivkey，导出的格式可能因钱包文件版本而不同。",
